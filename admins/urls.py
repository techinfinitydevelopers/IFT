...
urlpatterns = [
    ...
    path('user-management/bulk-upload-students/', views.bulk_upload_students, name='bulk_upload_students'),
    path('user-management/bulk-upload-students/template/', views.bulk_students_template, name='bulk_students_template'),
    path('user-management/bulk-upload-students/parse/', views.bulk_parse_students_csv, name='bulk_parse_students_csv'),
    path('user-management/bulk-upload-students/create/', views.bulk_create_students_chunk, name='bulk_create_students_chunk'),
    path('user-management/bulk-upload-students/email-targets/', views.bulk_email_targets, name='bulk_email_targets'),
    path('user-management/bulk-upload-students/send-emails/', views.bulk_send_emails_chunk, name='bulk_send_emails_chunk'),
    path('user-management/bulk-upload-students/list/', views.bulk_students_list, name='bulk_students_list'),
